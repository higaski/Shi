...
.equ ENABLE_NUM_S, SHI_ENABLE_NUM_S
.equ ENABLE_TICK, SHI_ENABLE_TICK
.equ ENABLE_P, SHI_ENABLE_P
...
.equ ENABLE_D, SHI_ENABLE_D
.equ ENABLE_DOT_Q, SHI_ENABLE_DOT_Q
...
.equ ENABLE_NUM_START, SHI_ENABLE_NUM_START
...
.equ ENABLE_TO_NUMBER, SHI_ENABLE_TO_NUMBER
.equ ENABLE_TO_R, SHI_ENABLE_TO_R
.equ ENABLE_Q_DUP, SHI_ENABLE_Q_DUP
.equ ENABLE_FETCH, SHI_ENABLE_FETCH
.equ ENABLE_ABORT, SHI_ENABLE_ABORT
.equ ENABLE_ABORT_Q, SHI_ENABLE_ABORT_Q
.equ ENABLE_ABS, SHI_ENABLE_ABS
.equ ENABLE_ACCEPT, SHI_ENABLE_ACCEPT
...
.equ ENABLE_EMIT, SHI_ENABLE_EMIT
.equ ENABLE_ENVIRONMENT_Q, SHI_ENABLE_ENVIRONMENT_Q
.equ ENABLE_ERASE, SHI_ENABLE_ERASE
.equ ENABLE_EVALUATE, SHI_ENABLE_EVALUATE
...
.equ ENABLE_HOLD, SHI_ENABLE_HOLD
...
.equ ENABLE_QUIT, SHI_ENABLE_QUIT
...
.equ ENABLE_SPACE, SHI_ENABLE_SPACE
.equ ENABLE_SPACES, SHI_ENABLE_SPACES
.equ ENABLE_STATE, SHI_ENABLE_STATE
.equ ENABLE_SWAP, SHI_ENABLE_SWAP
.equ ENABLE_THEN, SHI_ENABLE_THEN
.equ ENABLE_TYPE, SHI_ENABLE_TYPE
.equ ENABLE_U_D, SHI_ENABLE_U_D
...
.equ ENABLE_WORD, SHI_ENABLE_WORD
...
.equ ENABLE_COLON_NONAME, SHI_ENABLE_COLON_NONAME
...
.equ ENABLE_C_Q, SHI_ENABLE_C_Q
.equ ENABLE_CASE, SHI_ENABLE_CASE
.equ ENABLE_COMPILE_COMMA, SHI_ENABLE_COMPILE_COMMA
.equ ENABLE_DEFER, SHI_ENABLE_DEFER
.equ ENABLE_DEFER_STORE, SHI_ENABLE_DEFER_STORE
.equ ENABLE_DEFER_FETCH, SHI_ENABLE_DEFER_FETCH
...
.equ ENABLE_HOLDS, SHI_ENABLE_HOLDS
.equ ENABLE_IS, SHI_ENABLE_IS
.equ ENABLE_MARKER, SHI_ENABLE_MARKER
.equ ENABLE_NIP, SHI_ENABLE_NIP
.equ ENABLE_OF, SHI_ENABLE_OF
.equ ENABLE_PAD, SHI_ENABLE_PAD
.equ ENABLE_PARSE, SHI_ENABLE_PARSE
.equ ENABLE_PARSE_NAME, SHI_ENABLE_PARSE_NAME
.equ ENABLE_PICK, SHI_ENABLE_PICK
.equ ENABLE_REFILL, SHI_ENABLE_REFILL
.equ ENABLE_RESTORE_INPUT, SHI_ENABLE_RESTORE_INPUT
.equ ENABLE_ROLL, SHI_ENABLE_ROLL
.equ ENABLE_S_EQ, SHI_ENABLE_S_EQ
.equ ENABLE_SAVE_INPUT, SHI_ENABLE_SAVE_INPUT
.equ ENABLE_SOURCE_ID, SHI_ENABLE_SOURCE_ID
.equ ENABLE_TO, SHI_ENABLE_TO
.equ ENABLE_TRUE, SHI_ENABLE_TRUE
.equ ENABLE_TUCK, SHI_ENABLE_TUCK
.equ ENABLE_U_DOT_R, SHI_ENABLE_U_DOT_R
